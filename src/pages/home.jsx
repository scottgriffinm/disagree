...
const DisagreePlatform = () => {
  ...
  const handleSort = (key) => {
    ...
    const sortedRooms = [...rooms].sort((a, b) => {
      ...
      if (key === "stance") {
        // Assign scores based on party and percentage
        const aScore =
          a.stance.party === "Democrat"
            ? -a.stance.percentage
            : a.stance.percentage; // Republicans are offset
        const bScore =
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-900/50">
                  <th
                    className="px-4 py-4 text-left cursor-pointer hover:bg-gray-700/50 transition-colors"
                  ...
                  <th
                    className="px-4 py-4 text-left cursor-pointer hover:bg-gray-700/50 transition-colors whitespace-nowrap w-[150px]"
